...
- [x] **T-1.1** Define OutputFormat type and update FormatterOptions [T] [P]
...
- [x] **T-1.2** Create resolveOutputFormat() with TTY detection [T] [P]
...
- [x] **T-1.3** Rename PrettyFormatter to TableFormatter [T]
  - File: `src/utils/output-formatter.ts`
  - Test: `tests/output-formatter.test.ts`
...
- [x] **T-2.1** Implement CsvFormatter [T] [P] (depends: T-1.1)
  - File: `src/utils/output-formatter.ts`
...
- [x] **T-2.2** Implement IdsFormatter [T] [P] (depends: T-1.1)
  - File: `src/utils/output-formatter.ts`
...
- [x] **T-2.3** Implement MinimalFormatter [T] [P] (depends: T-1.1)
  - File: `src/utils/output-formatter.ts`
...
- [x] **T-2.4** Implement JsonlFormatter [T] [P] (depends: T-1.1)
  - File: `src/utils/output-formatter.ts`
...
- [x] **T-2.5** Update createFormatter() factory [T] (depends: T-1.3, T-2.1, T-2.2, T-2.3, T-2.4)
  - File: `src/utils/output-formatter.ts`
  - Test: `tests/output-formatter.test.ts`
...
- [x] **T-3.1** Add --format option to addStandardOptions() [T] (depends: T-1.2)
...
- [x] **T-3.2** Add SUPERTAG_FORMAT to config schema (depends: T-1.2)
...
- [x] **T-4.1** Migrate search command [T] [P] (depends: T-2.5, T-3.1)
...
- [x] **T-4.2** Migrate nodes command [T] [P] (depends: T-2.5, T-3.1)
...
- [x] **T-4.3** Migrate tags command [T] [P] (depends: T-2.5, T-3.1)
...
- [x] **T-4.4** Migrate fields command [T] [P] (depends: T-2.5, T-3.1)
...
- [x] **T-4.5** Migrate transcript command [T] [P] (depends: T-2.5, T-3.1)
  - File: `src/commands/transcript.ts`
  - Test: `tests/commands/transcript.test.ts`
  - Description: Update list, show, search subcommands to use new format system.

- [x] **T-4.6** Migrate stats and embed commands [T] [P] (depends: T-2.5, T-3.1)
...
- [x] **T-5.1** End-to-end format integration tests [T] (depends: T-4.1)
...
- [x] **T-5.2** Update documentation (depends: T-5.1)
