...
- [x] **T-1.1** Define TypeScript types for tool registry [T] [P]
...
- [x] **T-1.2** Define Zod schemas for MCP tools [T] [P]
...
- [x] **T-1.3** Implement tool metadata registry [T] (depends: T-1.1)
...
- [x] **T-1.4** Implement getCapabilities() [T] (depends: T-1.3)
  - File: `src/mcp/tool-registry.ts`
  - Test: `src/mcp/__tests__/tool-registry.test.ts`
  - Description: Return lightweight capabilities inventory, optional category filter

- [x] **T-1.5** Implement getToolSchema() with caching [T] (depends: T-1.3)
  - File: `src/mcp/tool-registry.ts`
  - Test: `src/mcp/__tests__/tool-registry.test.ts`
...
- [x] **T-2.1** Implement tana_capabilities handler [T] (depends: T-1.4)
...
- [x] **T-2.2** Implement tana_tool_schema handler [T] (depends: T-1.5)
...
- [x] **T-2.3** Token budget validation [T] (depends: T-2.1)
...
- [x] **T-3.1** Register tools in MCP server [T] (depends: T-2.1, T-2.2)
